...
class CourseOutlineController extends Controller {
	...
	public function store()
	{
		...
		if($validator->fails()) {
         return redirect('courseoutline/create')->withErrors($validator)->withInput($submitted_info);
		}
     ...
     $new_outline = [
        ...
        return view('pages.pdfs.display', ['outline' => $new_outline]);
	}
